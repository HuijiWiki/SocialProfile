  ...
  // 			'class' => 'ToggleSwitchWidget',
		...
		$output .= $templateParser->processTemplate(
				    ...
				    array(
				        ...
				        'yesterdayEdit' => HuijiFunctions::format_nice_number($ueb->getSiteEditCount( '', $wgHuijiPrefix, $yesterday, $yesterday )),
				        // 'totalEdit' => $totaledit,
				        // 'totalView' => $ueb->getSiteViewCount( -1, $wgHuijiPrefix, '', '' ),
				        'yesterdayView' => HuijiFunctions::format_nice_number($ueb->getSiteViewCount( -1, $wgHuijiPrefix, $yesterday, $yesterday )),
				        'newFollow' => $newFollow,
				        'sendToAll' => $sentToAll,
				        'showMore' => $showMore,
				        'display' => $display,
